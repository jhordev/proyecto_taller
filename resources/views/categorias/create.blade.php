...
<div class="flex items-center gap-3 mb-6">
    ...
    <div>
        <h1 class="text-xl font-bold text-slate-900">Nueva Categoría</h1>
        <p class="text-slate-500 text-sm">Registra una categoría para organizar tus productos.</p>
    </div>
</div>

<form action="{{ route('categorias.store') }}" method="POST" class="space-y-6 max-w-3xl">
    @csrf
    ...
    <div class="bg-white border border-slate-200">
        ...
        <div class="p-5 grid grid-cols-1 md:grid-cols-3 gap-x-4 gap-y-5">
            <div class="md:col-span-2">
                ...
                <input type="text" name="nombre" value="{{ old('nombre') }}" required placeholder="Ej: Limpieza, Alimentos..."
